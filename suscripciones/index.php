              ...
              <form class="" action="../controller/authenticate.php" method="post">
               ...
               ?>
                <div class="form-group  <?php echo $classgroup ?>">
                  <label class="textual-2">Ingresa los datos para descargar las suscripciones</label>
                ...
                <div class="form-group">
                  <button type="submit" class="btn btn-outline-qincha" name="button">Descargar</button>
                </div>
              </form>
            </div>
